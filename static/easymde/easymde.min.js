    ...
    return function e(t, n, i) {
        ...
        10: [function(e, t, n) {
            ! function(e, i) {
                ...
                function _a(e, t, n, i) {
                    e.setAttribute("autocorrect", n ? "on" : "off"), e.setAttribute("autocapitalize", i ? "on" : "off"), e.setAttribute("spellcheck", !!t)
                }
                ...
                function Wa() {
                    ...
                    return s ? e.style.width = "1000px" : e.setAttribute("wrap", "off"), g && (e.style.border = "1px solid black"), t
                }
                ...
                Ua.prototype.init = function(e) {
                    ...
                    function a(e) {
                        if (o(e) && !xe(i, e)) {
                            ...
                            var l = Wa(),
                                s = l.firstChild;
                            _a(s), i.display.lineSpace.insertBefore(l, i.display.lineSpace.firstChild), s.value = Oa.text.join("\n");
                ...
                Ka.prototype.init = function(e) {
                        ...
                        _a(this.textarea, t.spellcheck, t.autocorrect, t.autocapitalize)
        ...
        18: [function(e, t, n) {
            ...
            function h(e, t, n, i) {
                ...
                for (var a = 0; a < e.children.length; a++) {
                    ...
                    (l = f("string" == typeof s && s in ne ? ne[s] : s, !0, t, n, "button", i)).addEventListener("click", (function(e) {
                        e.stopPropagation()
                    }), !1), o.appendChild(l)
                }
            ...
            function m(e, t) {
                ...
                if (!n.type) return {};
                for (var i, r, o = n.type.split(" "), a = {}, l = 0; l < o.length; l++) "strong" === (i = o[l]) ? a.bold = !0 : "variable-2" === i ? (r = e.getLine(t.line), /^\s*\d+\.\s/.test(r) ? a["ordered-list"] = !0 : /^\s*- \[[ xX]]\s/.test(r) ? a["check-list"] = !0 : a["unordered-list"] = !0) : "atom" === i ? a.quote = !0 : "em" === i ? a.italic = !0 : "quote" === i ? a.quote = !0 : "strikethrough" === i ? a.strikethrough = !0 : "comment" === i ? a.code = !0 : "link" !== i || a.image ? "image" === i ? a.image = !0 : i.match(/^header(-[1-6])?$/) && (a[i.replace("header", "heading")] = !0) : a.link = !0;
                return a
            }
            var g = "";
            ...
            function x(e) {
                Z(e, "bold", e.options.blockStyles.bold)
            }
            ...
            function C(e) {
                X(e.codemirror, "quote")
            }

            function w(e) {
                V(e.codemirror, "smaller")
            }

            function k(e) {
                V(e.codemirror, "bigger")
            }

            function S(e) {
                V(e.codemirror, void 0, 1)
            }

            function F(e) {
                V(e.codemirror, void 0, 2)
            }

            function A(e) {
                V(e.codemirror, void 0, 3)
            }

            function E(e) {
                V(e.codemirror, void 0, 4)
            }

            function L(e) {
                V(e.codemirror, void 0, 5)
            }

            function T(e) {
                V(e.codemirror, void 0, 6)
            }

            function M(e) {
                var t = e.codemirror,
                    n = "*";
                ["-", "+", "*"].includes(e.options.unorderedListStyle) && (n = e.options.unorderedListStyle), X(t, "unordered-list", n)
            }

            function B(e) {
                X(e.codemirror, "ordered-list")
            }

            function N(e) {
                X(e.codemirror, "check-list")
            }
            ...
            function z(e) {
                ...
                K(e, "image", t.insertTexts.image, n)
            }
            ...
            function P(e, t) {
                ...
                if (["png", "jpg", "jpeg", "gif", "svg", "apng", "avif", "webp"].includes(a)) G(n, i.image, r.insertTexts.uploadedImage, t);
                else {
                    var l = r.insertTexts.link;
                    l[0] = "[" + o, G(n, i.link, l, t)
                }
            ...
            function _(e) {
                var t = e.codemirror,
                    n = m(t),
                    i = e.options;
                G(t, n.table, i.insertTexts.table)
            }
            ...
            function W(e) {
                var t = e.codemirror,
                    n = m(t),
                    i = e.options;
                G(t, n.image, i.insertTexts.horizontalRule)
            }
            ...
            function $(e) {
                var t = e.codemirror,
                    ...
                    o = n.lastChild;
                if (t.getWrapperElement().nextSibling.classList.contains("editor-preview-active-side") && U(e), !o || !o.classList.contains("editor-preview-full")) {
            ...
            function X(e, t, n) {
                if (!e.getWrapperElement().lastChild.classList.contains("editor-preview-active")) {
                    var i = /^(\s*)(\*|-|\+|\d*\.)(\s+)/,
                        ...
                        c = 1,
                        d = ["unordered-list", "ordered-list", "check-list"],
                        h = Object.keys(o)[0];
                    if (!d.includes(h)) {
                        var f = e.getLine(a.line);
                        /^\s*- \[[ xX]]\s/.test(f) ? h = "check-list" : /^\s*\d+\.\s/.test(f) ? h = "ordered-list" : /^\s*[*\-+]\s/.test(f) && (h = "unordered-list")
                    }
                    for (var p = a.line; p <= l.line; p++) ! function(n) {
                        var i = e.getLine(n);
                        o[t] ? i = i.replace(s[t], "$1") : d.includes(h) && d.includes(t) ? (i = i.replace(s[h], "$1"), i = u(t, i, !1), c += 1) : (i = u(t, i, !1), c += 1), e.replaceRange(i, {
                            line: n,
                            ch: 0
                        }, {
                            line: n,
            ...
            function Q(e, t) {
                for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (t[n] instanceof Array ? e[n] = t[n].concat(e[n] instanceof Array ? e[n] : []) : null !== t[n] && "object" == typeof t[n] && t[n].constructor === Object ? e[n] = Q(e[n] || {}, t[n]) : e[n] = t[n]);
                return e
            }

            function J(e) {
                for (var t = 1; t < arguments.length; t++) e = Q(e, arguments[t]);
                return e
            }
            ...
            var te = {
                ...
                ne = {
                    ...
                    "heading-smaller": {
                        ...
                        action: w,
                        className: te["heading-smaller"],
                        title: "Smaller Heading"
                    },
                    "heading-bigger": {
                        name: "heading-bigger",
                        action: k,
                        className: te["heading-bigger"],
                        title: "Bigger Heading"
                    },
                    "heading-1": {
                        name: "heading-1",
                        action: S,
                        className: te["heading-1"],
                        title: "Big Heading"
                    },
                    "heading-2": {
                        name: "heading-2",
                        action: F,
                        className: te["heading-2"],
                        title: "Medium Heading"
                    },
                    "heading-3": {
                        name: "heading-3",
                        action: A,
                        className: te["heading-3"],
                        title: "Small Heading"
                    },
                    "separator-1": {
                        name: "separator-1"
            ...
            function ue(e) {
                ...
                if (!1 === e.autoDownloadFontAwesome && (t = !1), !0 !== e.autoDownloadFontAwesome)
                    for (var n = document.styleSheets, i = 0; i < n.length; i++) n[i].href && n[i].href.indexOf("/fontawesome/") > -1 && (t = !1);
                if (t) {
                    var r = document.createElement("link");
                    r.rel = "stylesheet", r.href = "/fontawesome/css/all.min.css", document.getElementsByTagName("head")[0].appendChild(r)
                }
                if (e.element) this.element = e.element;
                else if (null === e.element) return void console.log("EasyMDE: Error. No element was found.");
                if (void 0 === e.toolbar)
                    for (var o in e.toolbar = [], ne) Object.prototype.hasOwnProperty.call(ne, o) && (-1 != o.indexOf("separator-") && e.toolbar.push("|"), (!0 === ne[o].default || e.showIcons && e.showIcons.constructor === Array && -1 != e.showIcons.indexOf(o)) && e.toolbar.push(o));
                if (Object.prototype.hasOwnProperty.call(e, "previewClass") || (e.previewClass = "editor-preview"), Object.prototype.hasOwnProperty.call(e, "status") || (e.status = ["autosave", "lines", "words", "cursor"], e.uploadImage && e.status.unshift("upload-image")), e.previewRender || (e.previewRender = function(e) {
                    ...
                    }, e.parsingConfig || {}), e.insertTexts = J({}, ie, e.insertTexts || {}), e.promptTexts = J({}, re, e.promptTexts || {}), e.blockStyles = J({}, ae, e.blockStyles || {}), null != e.autosave && (e.autosave.timeFormat = J({}, oe, e.autosave.timeFormat || {})), e.iconClassMap = J({}, te, e.iconClassMap || {}), e.shortcuts = J({}, u, e.shortcuts || {}), e.maxHeight = e.maxHeight || void 0, e.direction = e.direction || "ltr", void 0 !== e.maxHeight ? e.minHeight = e.maxHeight : e.minHeight = e.minHeight || "300px", e.errorCallback = e.errorCallback || function(e) {
                        alert(e)
                    }, e.uploadImage = e.uploadImage || !1, e.imageMaxSize = e.imageMaxSize || 2097152, e.imageAccept = e.imageAccept || "image/png, image/jpeg, image/gif, image/avif", e.imageTexts = J({}, le, e.imageTexts || {}), e.errorMessages = J({}, se, e.errorMessages || {}), e.imagePathAbsolute = e.imagePathAbsolute || !1, e.imageCSRFName = e.imageCSRFName || "csrfmiddlewaretoken", e.imageCSRFHeader = e.imageCSRFHeader || !1, e.imageInputName = e.imageInputName || "image", null != e.autosave && null != e.autosave.unique_id && "" != e.autosave.unique_id && (e.autosave.uniqueId = e.autosave.unique_id), e.overlayMode && void 0 === e.overlayMode.combine && (e.overlayMode.combine = !0), this.options = e, this.render(), !e.initialValue || this.options.autosave && !0 === this.options.autosave.foundSavedValue || this.value(e.initialValue), e.uploadImage) {
                    var a = this;
            ...
            ue.prototype.uploadImages = function(e, t, n) {
                if (0 !== e.length) {
            ...
            }, ue.prototype.uploadImagesUsingCustomFunction = function(e, t) {
                if (0 !== t.length) {
            ...
            }, ue.prototype.updateStatusBar = function(e, t) {
            ...
            }, ue.prototype.markdown = function(e) {
                if (o) {
                    var t;
                ...
                function x(e, t) {
                    var n, i, r = new URL(t.url, document.baseURI).href;
                    e.setAttribute("data-img-src", r), e.setAttribute("style", "--bg-image:url(" + r + ");--width:" + t.naturalWidth + "px;--height:" + (n = t.naturalWidth, i = t.naturalHeight, n < window.getComputedStyle(document.querySelector(".CodeMirror-sizer")).width.replace("px", "") ? i + "px" : i / n * 100 + "%")), m.codemirror.setSize()
                }
            ...
            }, ue.prototype.openBrowseFileWindow = function(e, t) {
                var n = this,
            ...
            }, ue.prototype.uploadImage = function(e, t, n) {
                var i = this;
                ...
                function o(t) {
                    ...
                    return t.replace("#image_name#", e.name).replace("#image_size#", Y(e.size, n)).replace("#image_max_size#", Y(i.options.imageMaxSize, n))
                }
                if (t = t || function(e) {
                        P(i, e)
            ...
            }, ue.prototype.uploadImageUsingCustomFunction = function(e, t) {
                var n = this;
                e.apply(this, [t, function(e) {
                    ...
                    var i = function(e) {
                        ...
                        return e.replace("#image_name#", t.name).replace("#image_size#", Y(t.size, i)).replace("#image_max_size#", Y(n.options.imageMaxSize, i))
                    }(e);
            ...
            }, ue.prototype.createToolbar = function(e) {
                if ((e = e || this.options.toolbar) && 0 !== e.length) {
                    var t;
                    for (t = 0; t < e.length; t++) null != ne[e[t]] && (e[t] = ne[e[t]]);
                        ...
                        if (("guide" != e[t].name || !1 !== i.options.toolbarGuideIcon) && !(i.options.hideIcons && -1 != i.options.hideIcons.indexOf(e[t].name) || ("fullscreen" == e[t].name || "side-by-side" == e[t].name) && c())) {
                            if ("|" === e[t]) {
                                ...
                                if (t = "|" === e ? p() : e.children ? h(e, i.options.toolbarTips, i.options.shortcuts, i) : f(e, !0, i.options.toolbarTips, i.options.shortcuts, "button", i), r[e.name || e] = t, n.appendChild(t), "upload-image" === e.name) {
                                    ...
                                    o.className = "imageInput", o.type = "file", o.multiple = !0, o.name = i.options.imageInputName, o.accept = i.options.imageAccept, o.style.display = "none", o.style.opacity = 0, n.appendChild(o)
                                }
                            }(e[t])
                        }
            ...
            }, ue.prototype.createStatusbar = function(e) {
